...
class TelegramPublisher(BasePublisher):
    ...
    def _send_media(self, token: str, chat_id: str, content: GeneratedContent) -> None:
        """Attach the day's card image / short video (best-effort)."""
    ...
    def publish(self, content: GeneratedContent) -> PublishResult:
        ...
        try:
            self._send_media(token, chat_id, content)
            r = requests.post(
